...
import {
    ...
    Clock, Shield, Database, ChevronRight, Check, Trash2, Info,
} from 'lucide-react';
    ...
    return (
            ...
            <motion.div variants={container} initial="hidden" animate="show" style={{ maxWidth: 720, margin: '0 auto' }}>
                ...
                <SettingSection title="Data Management" icon={Database}>
                    <SettingRow label="Export as JSON" description="Download all your data">
                        <motion.button
                            ...
                            style={{
                                ...
                                background: 'var(--surface-input)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6,
                    ...
                    <SettingRow label="Export Tasks as CSV" description="Spreadsheet-compatible export">
                        <motion.button
                            whileHover={{ scale: 1.03 }}
                            whileTap={{ scale: 0.97 }}
                    ...
                    <SettingRow label="Clear All Data" description="⚠️ This cannot be undone">
                        <motion.button
                            ...
                            style={{
                                padding: '8px 16px', borderRadius: 10, border: '1px solid rgba(244,63,94,0.3)',
                                background: 'rgba(244,63,94,0.08)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6,
                                color: 'var(--accent-rose)', fontSize: 13, fontWeight: 600,
                            }}
                        >
